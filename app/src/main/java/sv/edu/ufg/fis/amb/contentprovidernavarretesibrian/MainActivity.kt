package sv.edu.ufg.fis.amb.contentprovidernavarretesibrian
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createImagenUri():Uri {
        ...
        return FileProvider.getUriForFile(this, "sv.edu.ufg.fis.amb.contentprovidernavarretesibrian.FileProvider", imagen)
    }
